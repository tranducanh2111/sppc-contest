...
const BlogCard: React.FC<CardProps> = ({ imageURL, category, name, descriptions, author, publishDate, testURL, buttonText }) => {
  return (
    <section className="aspect-[341/381] rounded-[12px] bg-[#FBFDFF] shadow-lg pb-[16px] sm:pb-[24px]">
        ...
        <article className='px-[16px]'>
            ...
            <p className='overflow-y-hidden h-[44px] w-auto leading-[22px] text-body line-clamp-2 mb-[1.25rem]'>{descriptions}</p>
