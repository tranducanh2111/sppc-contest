...
const Custom404 = () => {
  return (
    <section className="lg:flex items-center justify-center min-h-[80vh] gap-x-[3rem]">
        ...
        <div className='flex flex-col items-center'>
          <h1 className="text-center text-3xl md:text-h2 lg:text-h1 font-bold text-gray-800 uppercase tracking-widest mb-[0.75rem]">AWWW...Don&apos;t cry.</h1>
